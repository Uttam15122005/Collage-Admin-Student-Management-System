      ...
      <div class="wpsp-card">
        <div class="wpsp-card-head">
          <h3 class="wpsp-card-title">
            <!-- <?php //echo apply_filters( 'wpsp_student_title_personal_detail', esc_html__( 'Personal Details', 'wpschoolpress' )); 
                  ?> -->
            <?php echo esc_html__('Personal Details', 'wpschoolpress'); ?>
          </h3>
        </div>
          ...
          <div class="wpsp-row">
            ...
            <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
              <div class="wpsp-form-group">
                ...
                <div class="wpsp-profileUp">
                  <img class="wpsp-upAvatar" id="img_preview" src="<?php echo esc_url(plugins_url('img/default_avtar.jpg', dirname(__FILE__))) ?>">
            ...
            <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
              <div class="wpsp-form-group">
                ...
                <input type="text" class="wpsp-form-control" data-is_required="<?php echo esc_attr($is_required); ?>" id="Dob" name="s_dob" placeholder="mm/dd/yyyy" readonly>
              </div>
            </div>
            <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
              <div class="wpsp-form-group">
            ...
            <div class="wpsp-col-lg-3 wpsp-col-md-4 wpsp-col-sm-4 wpsp-col-xs-12">
              <div class="wpsp-form-group">
                ...
                <input type="text" data-is_required="<?php echo esc_attr($is_required); ?>" class="wpsp-form-control" id="s_phone" name="s_phone" onkeypress='return event.keyCode == 8 || event.keyCode == 46 || event.keyCode == 37 || event.keyCode == 39 || event.charCode >= 48 && event.charCode <= 57'>
                ...
                <div class="wpsp-col-md-3 wpsp-col-sm-4 wpsp-col-xs-12">
                  <div class="wpsp-form-group">
                    <label class="wpsp-label" for="phone">
                      <?php esc_html_e("Parent Phone", "wpschoolpress");
                      /*Check Required Field*/
                      if (isset($is_required_parent['s_p_phone'])) {
          ...
          <div class="wpsp-card">
            ...
            <div class="wpsp-card-body">
              ...
              <div class="wpsp-form-group">
                ...
                <input type="text" class="wpsp-form-control select_date Doj" id="Doj" name="s_doj" value="<?php echo esc_attr(date('m/d/Y')); ?>" placeholder="mm/dd/yyyy" readonly>
              </div>
              <div class="wpsp-row">
